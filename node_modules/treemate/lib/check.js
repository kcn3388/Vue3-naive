...
function getCheckedKeys(options, treeMate) {
    ...
    if (!cascade) {
        if (keysToCheck !== undefined) {
            return {
                checkedKeys: utils_1.merge(checkedKeys, keysToCheck),
                indeterminateKeys: Array.from(indeterminateKeys)
            };
        }
        else if (keysToUncheck !== undefined) {
            return {
                checkedKeys: utils_1.minus(checkedKeys, keysToUncheck),
                indeterminateKeys: Array.from(indeterminateKeys)
            };
        }
        else {
...
function getExtendedCheckedKeySet(checkedKeys, leafOnly, treeMate) {
    ...
    checkedKeys.forEach((checkedKey) => {
        ...
        if (checkedTreeNode !== undefined) {
            utils_1.traverse(checkedTreeNode, (treeNode) => {
                const { key } = treeNode;
                ...
                if (treeNode.disabled) {
                    ...
                    if (utils_1.isExpilicitlyNotLoaded(treeNode.rawNode)) {
