...
exports.createIndexGetter = exports.isGroup = exports.minus = exports.merge = exports.unwrapIndeterminateKeys = exports.unwrapCheckedKeys = exports.isNodeInvalid = exports.isExpilicitlyNotLoaded = exports.isDisabled = exports.isShallowLoaded = exports.isIgnored = exports.defaultGetKey = exports.defaultGetChildren = exports.isLeaf = exports.getNonLeafKeys = exports.traverse = exports.TRAVERSE_COMMAND = exports.toArray = void 0;
...
function isLeaf(rawNode) {
    ...
    if (isLeaf !== undefined)
        return isLeaf;
    else if (rawNode.children === undefined)
        return true;
    return false;
}
