...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        const keyIndexMapRef = vue_1.computed(() => {
            const map = new Map();
        ...
        const listElRef = vue_1.ref(null);
        const listHeightRef = vue_1.ref(undefined);
        const keyToHeightOffset = new Map();
        const finweckTreeRef = vue_1.computed(() => {
        ...
        const finweckTreeUpdateTrigger = vue_1.ref(0);
        const scrollTopRef = vue_1.ref(0);
        const startIndexRef = vooks_1.useMemo(() => {
            return Math.max(finweckTreeRef.value.getBound(scrollTopRef.value - seemly_1.depx(props.paddingTop)) - 1, 0);
        });
        const viewportItemsRef = vue_1.computed(() => {
        ...
        function scrollToIndex(index, behavior, debounce) {
            ...
            const targetTop = ft.sum(index) + seemly_1.depx(props.paddingTop);
            if (!debounce) {
        ...
        function handleListScroll(e) {
            seemly_1.beforeNextFrameOnce(syncViewport);
        ...
        return {
            ...
            itemsStyle: vue_1.computed(() => {
                ...
                const height = seemly_1.pxfy(finweckTreeRef.value.sum());
            ...
            visibleItemsStyle: vue_1.computed(() => {
                ...
                finweckTreeUpdateTrigger.value;
                return {
                    transform: `translate3d(0, ${seemly_1.pxfy(finweckTreeRef.value.sum(startIndexRef.value))}, 0)`
                };
            }),
            viewportItems: viewportItemsRef,
            listElRef,
            itemsElRef: vue_1.ref(null),
            scrollTo,
            handleListResize,
            handleListScroll,
            handleItemResize
    ...
    render() {
        ...
        return vue_1.h(src_1.default, {
            ...
            default: () => {
                var _a, _b;
                return vue_1.h('div', vue_1.mergeProps(this.$attrs, {
                    class: [
                        'v-vl',
                    ...
                    this.items.length !== 0
                        ? vue_1.h('div', {
                            ...
                            vue_1.h(visibleItemsTag, Object.assign({
