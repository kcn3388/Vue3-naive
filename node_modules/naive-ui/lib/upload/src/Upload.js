...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        const mergedFileListRef = vooks_1.useMergedState(vue_1.toRef(props, 'fileList'), uncontrolledFileListRef);
    ...
    render() {
        ...
        const firstChild = _utils_1.getFirstSlotVNode(this.$slots, 'default');
        // @ts-expect-error
