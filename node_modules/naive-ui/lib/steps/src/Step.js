                ...
                vue_1.h("div", { class: `${mergedClsPrefix}-step-indicator-slot` },
                    vue_1.h(_internal_1.NIconSwitchTransition, null, {
                        default: () => {
                            ...
                            return !(mergedStatus === 'finish' || mergedStatus === 'error') ? (vue_1.h("div", { key: this.internalIndex, class: `${mergedClsPrefix}-step-indicator-slot__index` }, this.internalIndex)) : mergedStatus === 'finish' ? (vue_1.h(_internal_1.NBaseIcon, { clsPrefix: mergedClsPrefix, key: "finish" }, { default: () => vue_1.h(icons_1.CheckmarkIcon, null) })) : mergedStatus === 'error' ? (vue_1.h(_internal_1.NBaseIcon, { clsPrefix: mergedClsPrefix, key: "error" }, { default: () => vue_1.h(icons_1.CloseIcon, null) })) : null;
                        }
                    })),
