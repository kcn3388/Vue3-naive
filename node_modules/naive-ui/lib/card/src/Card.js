...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        return {
            ...
            cssVars: vue_1.computed(() => {
                const { size } = props;
                const { self: { color, colorModal, textColor, titleTextColor, titleFontWeight, borderColor, actionColor, borderRadius, closeColor, closeColorHover, closeColorPressed, lineHeight, closeSize, boxShadow, colorPopover, [_utils_1.createKey('padding', size)]: padding, [_utils_1.createKey('fontSize', size)]: fontSize, [_utils_1.createKey('titleFontSize', size)]: titleFontSize }, common: { cubicBezierEaseInOut } } = themeRef.value;
    ...
    render() {
        ...
        return (vue_1.h("div", { class: [
            ...
            $slots.header || this.title || this.closable ? (vue_1.h("div", { class: `${mergedClsPrefix}-card-header` },
                vue_1.h("div", { class: `${mergedClsPrefix}-card-header__main`, style: this.headerStyle, role: "heading" }, vue_1.renderSlot($slots, 'header', {}, () => [this.title])),
