            ...
            return (vue_1.h("div", { class: `${clsPrefix}-progress-content` },
                vue_1.h("div", { class: `${clsPrefix}-progress-graph` },
                    vue_1.h("div", { class: `${clsPrefix}-progress-graph-circle` },
                        vue_1.h("svg", { viewBox: `0 0 ${viewBoxWidth} ${viewBoxWidth}` }, percentage.map((p, index) => {
                            return (vue_1.h("g", { key: index },
                                vue_1.h("path", { class: `${clsPrefix}-progress-graph-circle-rail`, d: circlePath(viewBoxWidth / 2 -
                ...
                showIndicator && slots.default ? (vue_1.h("div", null,
                    vue_1.h("div", { class: `${clsPrefix}-progress-text` }, slots.default()))) : null));
        };
    }
});
