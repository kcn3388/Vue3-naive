...
exports.default = cssr_1.cB('dropdown-menu', `
...
`, [fade_in_scale_up_cssr_1.default(), cssr_1.cB('dropdown-option', {
  position: 'relative'
}, [cssr_1.cB('dropdown-option-body', `
 display: flex;
 cursor: default;
 ...
 `, [cssr_1.cM('has-submenu', {
  width: 'var(--option-icon-suffix-width)'
}), cssr_1.cB('icon', {
  fontSize: 'var(--option-icon-size)'
})]), cssr_1.cB('dropdown-menu', {
  pointerEvents: 'all'
})]), cssr_1.cB('dropdown-offset-container', `
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 top: -4px;
 bottom: -4px;
 `)]), cssr_1.cB('dropdown-divider', `
 transition: background-color .3s var(--bezier);
 background-color: var(--divider-color);
 height: 1px;
 margin: 4px 0;
 `), cssr_1.cB('dropdown-menu-wrapper', `
 transform-origin: inherit;
 width: fit-content;
 `)]);