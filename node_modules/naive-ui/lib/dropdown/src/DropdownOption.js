...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        const { hoverKeyRef, keyboardKeyRef, lastToggledSubmenuKeyRef, pendingKeyPathRef, activeKeyPathRef, animatedRef, mergedShowRef } = NDropdown;
    ...
    render() {
        var _a;
        const { animated, rawNode, mergedShowSubmenu, clsPrefix, siblingHasIcon, siblingHasSubmenu } = this;
        ...
        return (vue_1.h("div", { class: `${clsPrefix}-dropdown-option` },
            vue_1.h("div", { class: [
                ...
                vue_1.h("div", { "__dropdown-option": true, class: `${clsPrefix}-dropdown-option-body__label` }, vue_1.h(_utils_1.render, { render: (_a = rawNode.label) !== null && _a !== void 0 ? _a : rawNode.title })),
                vue_1.h("div", { "__dropdown-option": true, class: [
