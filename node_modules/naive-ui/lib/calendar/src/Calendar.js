...
exports.default = vue_1.defineComponent({
    ...
    render() {
        ...
        const month = date_fns_1.getMonth(monthTs);
        ...
        return (vue_1.h("div", { class: `${mergedClsPrefix}-calendar`, style: cssVars },
            ...
            vue_1.h("div", { class: `${mergedClsPrefix}-calendar-dates` }, this.dateItems.map(({ ts, inCurrentMonth, isCurrentDate }, index) => {
                ...
                const date = date_fns_1.getDate(ts);
                return (vue_1.h("div", { key: isCurrentDate ? 'current' : index, class: [
                    ...
                    vue_1.h("div", { class: `${mergedClsPrefix}-calendar-date` },
                        disabled ? (vue_1.h("div", { class: `${mergedClsPrefix}-calendar-date__date`, key: "disabled" }, date)) : (vue_1.h("div", { class: `${mergedClsPrefix}-calendar-date__date`, key: "available" }, date)),
                        index < 7 && (vue_1.h("div", { class: `${mergedClsPrefix}-calendar-date__day` }, date_fns_1.format(ts, 'EEE', {
                            locale
                        })))),
