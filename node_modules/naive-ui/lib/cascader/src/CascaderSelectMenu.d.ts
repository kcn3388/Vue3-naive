...
import { TmNode, Value, Filter, BaseOption } from './interface';
declare const _default: import("vue").DefineComponent<{
    ...
    filter: {
        ...
        default: (pattern: string, _: BaseOption, path: BaseOption[]) => boolean;
    };
}, {
    prev: () => void;
    next: () => void;
    ...
    selectTreeMate: import("vue").ComputedRef<import("treemate").TreeMate<SelectBaseOption<string | number>, SelectGroupOption, SelectIgnoredOption>>;
    handleToggleOption: (option: BaseOption) => void;
