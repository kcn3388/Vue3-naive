...
exports.default = vue_1.defineComponent({
    ...
    setup(props) {
        ...
        function handleHandleMouseMove(e, handleIndex) {
            ...
            const offsetRatio = (e.clientX - railLeft - handleWidth / 2) / (railWidth - handleWidth);
        ...
        function handleFirstHandleMouseDown() {
            if (props.range) {
        ...
        function handleSecondHandleMouseDown() {
            if (props.range) {
        ...
        function handleHandleMouseUp(e) {
            var _a, _b;
            if (!((_a = handleRef1.value) === null || _a === void 0 ? void 0 : _a.contains(e.target)) &&
    ...
    render() {
        ...
        return (vue_1.h("div", { class: [
            ...
            vue_1.h(vueuc_1.VBinder, null, {
                default: () => [
                    vue_1.h(vueuc_1.VTarget, null, {
                        default: () => (vue_1.h("div", { ref: "handleRef1", class: `${mergedClsPrefix}-slider-handle`, tabindex: 0, style: this.firstHandleStyle, onFocus: this.handleHandleFocus1, onBlur: this.handleHandleBlur1, onMousedown: this.handleFirstHandleMouseDown, onMouseenter: this.handleFirstHandleMouseEnter, onMouseleave: this.handleFirstHandleMouseLeave }))
                    }),
                    vue_1.h(vueuc_1.VFollower, { ref: "followerRef1", show: this.mergedShowTooltip1, to: this.adjustedTo, teleportDisabled: this.adjustedTo === _utils_1.useAdjustedTo.tdkey, placement: this.placement, containerClass: this.namespace }, {
            ...
            this.range ? (vue_1.h(vueuc_1.VBinder, null, {
                default: () => [
                    vue_1.h(vueuc_1.VTarget, null, {
                        default: () => (vue_1.h("div", { ref: "handleRef2", class: `${mergedClsPrefix}-slider-handle`, tabindex: 0, style: this.secondHandleStyle, onFocus: this.handleHandleFocus2, onBlur: this.handleHandleBlur2, onMousedown: this.handleSecondHandleMouseDown, onMouseenter: this.handleSecondHandleMouseEnter, onMouseleave: this.handleSecondHandleMouseLeave }))
                    }),
