...
exports.default = vue_1.defineComponent({
    ...
    render() {
        ...
        return this.options.length ? (this.virtualScroll ? (vue_1.h(scrollbar_1.NScrollbar, { ref: "scrollerInstRef", theme: mergedTheme.peers.Scrollbar, themeOverrides: mergedTheme.peerOverrides.Scrollbar, container: this.scrollContainer, content: this.scrollContent }, {
            ...
            default: () => (vue_1.h(empty_1.NEmpty, { theme: mergedTheme.peers.Empty, themeOverrides: mergedTheme.peerOverrides.Empty }))
        }));
    }
});
