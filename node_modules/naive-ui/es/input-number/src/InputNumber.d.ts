...
declare const inputNumberProps: {
    ...
    'onUpdate:value': PropType<MaybeArray<(value: number) => void>>;
    onFocus: PropType<MaybeArray<(e: FocusEvent) => void>>;
    onBlur: PropType<MaybeArray<(e: FocusEvent) => void>>;
    onChange: {
        type: PropType<MaybeArray<(value: number) => void> | undefined>;
        validator: () => boolean;
        default: undefined;
    };
...
declare const _default: import("vue").DefineComponent<{
    ...
    disabled: boolean;
    step: string | number;
    onChange: MaybeArray<(value: number) => void> | undefined;
