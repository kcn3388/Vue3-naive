...
export default defineComponent({
    ...
    setup(props) {
        ...
        provide(datePickerInjectionKey, Object.assign(Object.assign({ mergedClsPrefixRef, mergedThemeRef: themeRef, timePickerSizeRef,
            localeRef,
            dateLocaleRef, isDateDisabledRef: toRef(props, 'isDateDisabled'), rangesRef: toRef(props, 'ranges') }, uniVaidation), dualValidation));
        return {
                ...
                default: () => [
                    h(VTarget, null, {
                        default: () => this.isRange ? (h(NInput, Object.assign({ ref: "inputInstRef", value: [this.displayStartTime, this.displayEndTime], placeholder: [
                            ...
                            clear: () => (h(NBaseIcon, { clsPrefix: mergedClsPrefix, class: `${mergedClsPrefix}-date-picker-icon` }, { default: () => h(DateIcon, null) }))
