import { h, defineComponent, ref, computed, toRef, watchEffect, withDirectives, Transition, provide, watch } from 'vue';
        ...
        function renderPanel() {
            ...
            return (h("div", { class: `${mergedClsPrefix}-color-picker-panel`, onDragstart: (e) => {
                ...
                h("div", { class: `${mergedClsPrefix}-color-picker-control` },
                    ...
                    h(ColorInput, { clsPrefix: mergedClsPrefix, showAlpha: props.showAlpha, mode: displayedModeRef.value, onUpdateMode: handleUpdateDisplayedMode, value: mergedValueRef.value, valueArr: mergedValueArrRef.value, onUpdateValue: handleInputUpdateValue })),
