...
export default defineComponent({
    ...
    render() {
        ...
        let body;
        if (multiple) {
            const createTag = (option) => (h("div", { class: `${clsPrefix}-base-selection-tag-wrapper`, key: option.value },
                h(NTag, { size: size, closable: true, disabled: disabled, internalStopClickPropagation: true, onClose: () => this.handleDeleteOption(option) }, { default: () => option.label })));
            const originalTags = (maxTagCountNumeric
                ? this.selectedOptions.slice(0, maxTagCount)
                : this.selectedOptions).map(createTag);
            const input = filterable ? (h("div", { class: `${clsPrefix}-base-selection-input-tag`, key: "__input-tag__" },
            ...
            const popoverProps = useMaxTagCount
                ...
                : null;
            const placeholder = !this.selected && !this.pattern && !this.isCompositing ? (h("div", { class: `${clsPrefix}-base-selection-placeholder` }, this.placeholder)) : null;
            if (filterable) {
            ...
            if (filterable) {
                const showPlaceholder = !this.pattern &&
                    ...
                    !this.isCompositing;
                body = (h(Fragment, null,
                    h("div", { ref: "patternInputWrapperRef", class: `${clsPrefix}-base-selection-label` },
                        h("input", { ref: "patternInputRef", class: `${clsPrefix}-base-selection-label__input`, value: showPlaceholder
                                ? ''
                        ...
                        showPlaceholder ? (h("div", { class: `${clsPrefix}-base-selection-placeholder` }, this.filterablePlaceholder)) : null,
                        suffix)));
            }
            else {
                body = (h(Fragment, null,
                    h("div", { ref: "singleElRef", class: `${clsPrefix}-base-selection-label`, tabindex: this.disabled ? undefined : 0 },
                        this.label !== undefined ? (h("div", { class: `${clsPrefix}-base-selection-label__input`, key: "input" }, this.label)) : (h("div", { class: `${clsPrefix}-base-selection-placeholder`, key: "placeholder" }, this.placeholder)),
                        suffix)));
            }
        }
