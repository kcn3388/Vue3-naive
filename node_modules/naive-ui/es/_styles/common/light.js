...
const derived = Object.assign(Object.assign({ name: 'common' }, commonVariables), { baseColor: base.neutralBase, 
    ...
    // close
    closeColor: neutral(Number(base.alphaClose)), closeColorHover: neutral(Number(base.alphaClose) * 1.25), closeColorPressed: neutral(Number(base.alphaClose) * 0.8), closeColorDisabled: neutral(base.alpha4), closeOpacity: base.alphaClose, closeOpacityHover: String(roundAlpha(Number(base.alphaClose) * 1.25)), closeOpacityPressed: String(roundAlpha(Number(base.alphaClose) * 0.8)), 
    // clear
