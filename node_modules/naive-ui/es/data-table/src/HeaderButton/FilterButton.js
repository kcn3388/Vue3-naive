...
export default defineComponent({
    ...
    render() {
        ...
        return (h(NPopover, { show: this.showPopover, onUpdateShow: (v) => (this.showPopover = v), trigger: "click", theme: mergedTheme.peers.Popover, themeOverrides: mergedTheme.peerOverrides.Popover, padded: false }, {
            trigger: () => {
