...
export declare const dataTableProps: {
    ...
    readonly rowClassName: PropType<string | CreateRowClassName>;
    readonly rowProps: PropType<CreateRowProps>;
    readonly rowKey: PropType<CreateRowKey>;
    readonly loading: {
    ...
    readonly summary: PropType<CreateSummary>;
