import { h, computed, defineComponent, ref, provide, toRef } from 'vue';
...
export const dataTableProps = Object.assign(Object.assign({}, useTheme.props), { pagination: {
        type: [Object, Boolean],
        default: false
    }, minHeight: [Number, String], maxHeight: [Number, String], columns: {
        type: Array,
        default: () => []
    }, data: {
        type: Array,
        default: () => []
    }, rowClassName: [String, Function], rowProps: Function, rowKey: Function, loading: {
        type: Boolean,
        default: false
    }, bordered: {
        type: Boolean,
        ...
        type: Array,
        default: []
    }, expandedRowKeys: Array, summary: [Function], virtualScroll: Boolean, tableLayout: {
        type: String,
        default: 'auto'
    }, cascade: {
        type: Boolean,
    ...
    // eslint-disable-next-line vue/prop-name-casing
    'onUpdate:checkedRowKeys': [Function, Array], 'onUpdate:expandedRowKeys': [Function, Array], onUpdateExpandedRowKeys: [Function, Array], 
    // deprecated
    onPageChange: {
        type: [Function, Array],
        validator: () => {
                    ...
                    h("div", { class: `${mergedClsPrefix}-data-table-wrapper` },
                        h(NMainTable, { ref: "mainTableInstRef" }, {
                            default: () => this.paginatedData.length === 0 ? (h("div", { class: [
                                ...
                                h(NEmpty, { theme: this.mergedTheme.peers.Empty, themeOverrides: this.mergedTheme.peerOverrides.Empty }))) : null
                        })),
