...
import { ColumnKey, FilterState, SortOrder, SortState, TableBaseColumn, TableSelectionColumn, RowData, TmNode, TableExpandColumn, RowKey } from './interface';
...
export declare function useTableData(props: DataTableSetupProps, { dataRelatedColsRef }: {
    ...
    treeMateRef: ComputedRef<import("treemate").TreeMate<RowData, RowData, RowData>>;
    ...
    rawPaginatedDataRef: ComputedRef<RowData[]>;
    ...
    doUpdateFilters: (filters: FilterState, sourceColumn?: TableBaseColumn | undefined) => void;
