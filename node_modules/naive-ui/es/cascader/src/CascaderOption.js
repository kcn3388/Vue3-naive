    ...
    render() {
        ...
        return (h("div", { class: [
            ...
            h("div", { class: `${mergedClsPrefix}-cascader-option__suffix` },
                h("div", { class: `${mergedClsPrefix}-cascader-option-icon-placeholder` }, !this.isLeaf ? (h(NBaseLoading, { clsPrefix: mergedClsPrefix, scale: 0.8, strokeWidth: 20, show: this.isLoading, class: `${mergedClsPrefix}-cascader-option-icon` }, {
