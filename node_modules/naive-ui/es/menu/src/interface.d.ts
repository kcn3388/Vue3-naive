...
export declare type OnUpdateValue = <T extends string & number & (string | number)>(value: T, item: MenuOption) => void;
export declare type OnUpdateKeys = <T extends string[] & number[] & Array<string | number>>(keys: T) => void;
export declare type OnUpdateValueImpl = <T extends string | number | (string | number)>(value: T, item: MenuOption) => void;
