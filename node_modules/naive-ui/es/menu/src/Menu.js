...
const menuProps = Object.assign(Object.assign({}, useTheme.props), { options: {
        ...
        type: String,
        default: 'vertical'
    }, disabled: Boolean, inverted: Boolean, 
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const mergedCollapsedRef = computed(() => {
            var _a, _b;
            return (_b = (_a = props.collapsed) !== null && _a !== void 0 ? _a : layoutSider === null || layoutSider === void 0 ? void 0 : layoutSider.collapsedRef.value) !== null && _b !== void 0 ? _b : false;
        });
        ...
        function doUpdateExpandedKeys(value) {
            const { 'onUpdate:expandedKeys': onUpdateExpandedKeys, onExpandedNamesChange, onOpenNamesChange } = props;
