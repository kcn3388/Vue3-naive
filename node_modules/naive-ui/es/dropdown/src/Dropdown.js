import { defineComponent, h, computed, ref, toRef, watch, provide } from 'vue';
...
export default defineComponent({
    ...
    render() {
        return h(NPopover, keep(this.$props, popoverPropKeys, {
