import { h, computed, inject, ref, Transition, defineComponent, provide } from 'vue';
    ...
    render() {
        ...
        return (h("div", { class: `${clsPrefix}-dropdown-option` },
            h("div", { class: [
                ...
                h("div", { "__dropdown-option": true, class: `${clsPrefix}-dropdown-option-body__label` }, h(render, { render: (_a = rawNode.label) !== null && _a !== void 0 ? _a : rawNode.title })),
                h("div", { "__dropdown-option": true, class: [
