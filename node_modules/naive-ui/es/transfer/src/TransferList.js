import { h, defineComponent, ref, inject, TransitionGroup, Transition } from 'vue';
...
export default defineComponent({
    ...
    render() {
        ...
        return this.options.length ? (this.virtualScroll ? (h(NScrollbar, { ref: "scrollerInstRef", theme: mergedTheme.peers.Scrollbar, themeOverrides: mergedTheme.peerOverrides.Scrollbar, container: this.scrollContainer, content: this.scrollContent }, {
            default: () => (h(VirtualList, { ref: "srcVlInstRef", style: { height: '100%' }, class: `${mergedClsPrefix}-transfer-list-content`, items: this.options, itemSize: this.itemSize, showScrollbar: false, onResize: syncVLScroller, onScroll: syncVLScroller, keyField: "value" }, {
                default: ({ item }) => {
        ...
        })) : (h(NScrollbar, { theme: mergedTheme.peers.Scrollbar, themeOverrides: mergedTheme.peerOverrides.Scrollbar }, {
            default: () => (h("div", { class: `${mergedClsPrefix}-transfer-list-content` },
            ...
            default: () => (h(NEmpty, { theme: mergedTheme.peers.Empty, themeOverrides: mergedTheme.peerOverrides.Empty }))
        }));
    }
});
