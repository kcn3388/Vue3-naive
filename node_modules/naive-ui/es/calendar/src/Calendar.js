...
import { getDate, format, getYear, addMonths, startOfDay, startOfMonth, getMonth } from 'date-fns';
...
export default defineComponent({
    ...
    render() {
        ...
        return (h("div", { class: `${mergedClsPrefix}-calendar`, style: cssVars },
            ...
            h("div", { class: `${mergedClsPrefix}-calendar-dates` }, this.dateItems.map(({ ts, inCurrentMonth, isCurrentDate }, index) => {
                ...
                return (h("div", { key: isCurrentDate ? 'current' : index, class: [
                    ...
                    h("div", { class: `${mergedClsPrefix}-calendar-date` },
                        disabled ? (h("div", { class: `${mergedClsPrefix}-calendar-date__date`, key: "disabled" }, date)) : (h("div", { class: `${mergedClsPrefix}-calendar-date__date`, key: "available" }, date)),
                        index < 7 && (h("div", { class: `${mergedClsPrefix}-calendar-date__day` }, format(ts, 'EEE', {
                            locale
                        })))),
