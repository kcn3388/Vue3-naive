                ...
                h("div", { class: `${mergedClsPrefix}-step-indicator-slot` },
                    h(NIconSwitchTransition, null, {
                        default: () => {
                            ...
                            return !(mergedStatus === 'finish' || mergedStatus === 'error') ? (h("div", { key: this.internalIndex, class: `${mergedClsPrefix}-step-indicator-slot__index` }, this.internalIndex)) : mergedStatus === 'finish' ? (h(NBaseIcon, { clsPrefix: mergedClsPrefix, key: "finish" }, { default: () => h(FinishedIcon, null) })) : mergedStatus === 'error' ? (h(NBaseIcon, { clsPrefix: mergedClsPrefix, key: "error" }, { default: () => h(ErrorIcon, null) })) : null;
                        }
                    })),
