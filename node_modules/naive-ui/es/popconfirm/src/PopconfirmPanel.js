    ...
    render() {
        ...
        return (h("div", { style: this.cssVars },
            h("div", { class: `${mergedClsPrefix}-popconfirm__body` },
                this.showIcon ? (h("div", { class: `${mergedClsPrefix}-popconfirm__icon` },
                    h("slot", { name: "icon" },
                        h(NBaseIcon, { clsPrefix: mergedClsPrefix }, { default: () => h(WarningIcon, null) })))) : null,
                renderSlot(this.$slots, 'default')),
            h("div", { class: `${mergedClsPrefix}-popconfirm__action` }, renderSlot(this.$slots, 'action', undefined, () => [
                h(NButton, { size: "small", onClick: this.handleNegativeClick }, this.localizedNegativeText),
                h(NButton, { size: "small", type: "primary", onClick: this.handlePositiveClick }, this.localizedPositiveText)
            ]))));
    }
});
